...
/*
   IMPORTANT :
   Le backend PayDunya recalcule lui-même
   le montant à partir des IDs et quantités.
   On lui envoie donc uniquement les données
   qu'il attend.
*/
...
try {
    ...
    if (!data.url) {
        throw new Error(
            "Le backend n'a pas fourni de lien de paiement PayDunya."
        );
    }

    /*
       Le backend renvoie l'URL PayDunya.
       On redirige directement le client
       vers cette page.
    */
